...
"navigateTo", "backButton"], function() {
     ...
     */
    var APP = angular.module(window.__APPLICATION_NAME, ['ApperyioModule', "ionic", "uiGmapgoogle-maps"]).config(["$routeProvider", '$controllerProvider', '$provide', '$locationProvider', '$compileProvider', '$filterProvider', Configuration]).run(["Apperyio", "User", "$location", "$ionicPlatform", RUN]);
